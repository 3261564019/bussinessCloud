<template>
    <div class="home">
        <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
            <van-swipe-item v-for="i,index  in swiperList">
        ...
        <div class="piece">
            ...
            <div class="piece-content">
                <div class="piece-content-item" v-for="i,index in lsit1" @click="jumpage1(i.path)">
                    <img :src="i.url">
                    <span>{{i.text}}</span>
                </div>
            </div>
        ...
        <div class="piece">
            ...
            <div class="piece-content">
                <div class="piece-content-item" style="flex: 0 0 45%;margin: 15px 0 15px 0;" v-for="i,index in lsit2"
        ...
        <div class="news">
            ...
            <div class="news-content">
                <div class="news-content-item" v-for="i in linshi_list2"
                     :style="{'background-image': 'url('+i.images+')'}" @click="jumpDetails(i.id)">
                    <span>{{i.title}}</span>
                    <span>{{i.time}}</span>
                </div>
            </div>
        ...
        <div class="news-piece" v-for="i,index in linshi_list1" @click="jumpDetails(i.id)">
    ...
    export default {
        data() {
            return {
                ...
                swiperList: [
                    {fullimageurl: require('@/assets/linshi/icon1.png')},
                    {fullimageurl: require('@/assets/linshi/icon1.png')},
                ],
                lsit1: [
                ...
                lsit2: [
                    {text: '商业秘密保护措施备案', url: require('@/assets/home/group5.png')},
                    {text: '商业秘密保护保险', url: require('@/assets/home/group6.png'), code: 2},
