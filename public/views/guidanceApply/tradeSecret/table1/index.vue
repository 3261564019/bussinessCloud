  ...
  <div class="table1">
    <div class="content">
      ...
      <div class="block">
        ...
        <div class="block-right">
          <div style="width:100%;padding-left:5px;display: flex; color: rgb(133, 133, 133); justify-content:flex-start">
            请选择申请日期
          </div>
        </div>
      </div>
      <div class="block">
        ...
        <div class="block-right">
          <input placeholder="请输入编号" v-model="value4" />
        </div>
      </div>
      <div class="block">
        <div class="block-left">
        ...
        <div class="block-right">
          <input placeholder="请输入单位名称" v-model="value5" />
        </div>
      </div>
      <div class="block">
        <div class="block-left">
        ...
        <div class="block-right">
          <input placeholder="请选择经营地址" v-model="value6" />
        </div>
      </div>
      <div class="block">
        <div class="block-left">
        ...
        <div class="block-right">
          <input placeholder="请输入注册资本" v-model="value7" />
        </div>
      </div>
      ...
      <div class="block">
        ...
        <div class="block-right">
          <input placeholder="请输入主要产品" v-model="value9" />
        </div>
      </div>
      <div class="block">
        <div class="block-left">
        ...
        <div class="block-right">
          <input placeholder="请输入年产值" v-model="value8" />
        </div>
      </div>
    ...
    <div class="underThe">
      <!--<img src="@/assets/home/group18.png">-->
      <div></div>
...
export default {
  ...
  methods: {
    jumpPage() {
      this.$router.push({ path: "/tradeSecret/table2" });
    },
  },
};
</script>
